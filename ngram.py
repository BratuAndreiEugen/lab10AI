...
acc1 = 0
for i in range(0, len(predicted)):
    if data['Sentiment'][i] == 'positive' and predicted[i] == 0:
        acc1+=1
    if data['Sentiment'][i] == 'negative' and predicted[i] == 1:
        acc1+=1
print("Accuracy (0-positiv 1-negativ): ", acc1/len(predicted))

acc2 = 0
for i in range(0, len(predicted)):
    if data['Sentiment'][i] == 'positive' and predicted[i] == 1:
        acc2+=1
    if data['Sentiment'][i] == 'negative' and predicted[i] == 0:
        acc2+=1
